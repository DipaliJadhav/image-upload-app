          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                :key="item.name" 
                :to="item.to" 
                :class="[$route.name === item.to.name ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium']" 
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-white/10 pt-4 pb-3">
          ...
          <div class="mt-3 space-y-1 px-2">
            <DisclosureButton @click="logout" :class="['block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-white/5 hover:text-white']">Sign out</DisclosureButton>
          </div>
        </div>
      </DisclosurePanel>
    </Disclosure>
...
const navigation = [
  { name: 'Upload', to: {name: 'Images'} },
  { name: 'My Images', to: {name: 'Home'} },
]
function logout() {
